...
public class GamePanel extends JPanel {
    ...
    public static final Color bg = Color.pink;
    ...
    public GamePanel(FlappyBird fb, Bird bird, ArrayList<Rectangle> rects) {
        ...
        pauseFont = new Font("Arial", Font.BOLD, 46);
        
        try {
        	pipeHead = ImageIO.read(new File("pipe.png"));
        	pipeLength = ImageIO.read(new File("tube.png"));
        }
        catch(IOException e) {
            e.printStackTrace();
        }
    ...
    public void paintComponent(Graphics g) {
        ...
        if(fb.paused()) {
            g.setFont(pauseFont);
            g.setColor(Color.BLACK);
            g.drawString("WELCOME TO FLAPPY BIRD", FlappyBird.WIDTH/2-315, FlappyBird.HEIGHT/2-125);
            g.drawString("PRESS SPACE TO BEGIN", FlappyBird.WIDTH/2-275, FlappyBird.HEIGHT/2+75);
        }
    }
}